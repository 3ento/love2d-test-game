...
function Moan.draw(font_size)
  ...
  if Moan.showingMessage then
    ...
    -- Message text
    if Moan.autoWrap then
      love.graphics.print(printedText, textX, textY, nil, font_size)
    else
      love.graphics.printf(printedText, textX, textY, msgLimit, "left", nil, font_size)
    end
